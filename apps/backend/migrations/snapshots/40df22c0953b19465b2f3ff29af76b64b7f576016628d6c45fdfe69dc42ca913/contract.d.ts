...
export type StorageHash =
  StorageHashBase<'40df22c0953b19465b2f3ff29af76b64b7f576016628d6c45fdfe69dc42ca913'>;
...
export type FieldOutputTypes = {
  readonly public: {
    readonly Conversation: {
      ...
      readonly agentId: CodecTypes['pg/int4@1']['output'] | null;
    ...
    readonly Message: {
      ...
      readonly senderRole: 'CANDIDATE' | 'AGENT' | 'SUPERVISOR' | 'ADMIN';
    ...
    readonly User: {
      ...
      readonly role: 'CANDIDATE' | 'AGENT' | 'SUPERVISOR' | 'ADMIN';
      readonly supervisorId: CodecTypes['pg/int4@1']['output'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    readonly Conversation: {
      ...
      readonly agentId: CodecTypes['pg/int4@1']['input'] | null;
      readonly status: 'ACTIVE' | 'CLOSED';
    ...
    readonly User: {
      ...
      readonly role: 'CANDIDATE' | 'AGENT' | 'SUPERVISOR' | 'ADMIN';
      readonly supervisorId: CodecTypes['pg/int4@1']['input'] | null;
      readonly createdAt: CodecTypes['pg/timestamptz-string@1']['input'];
        ...
        readonly entries: {
          readonly table: {
            readonly conversation: {
              ...
              indexes: readonly [
                {
                  readonly name: 'conversation_candidateId_idx_462b5869';
                  readonly prefix: 'conversation_candidateId_idx';
                  readonly columns: readonly ['candidateId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'conversation_agentId_idx_8d0ba4f0';
                  readonly prefix: 'conversation_agentId_idx';
            ...
            readonly user: {
              ...
              indexes: readonly [
                {
                  readonly name: 'user_supervisorId_idx_fe423ed5';
                  readonly prefix: 'user_supervisorId_idx';
          ...
          readonly valueSet: {
            ...
            readonly Role: {
              readonly kind: 'valueSet';
              readonly values: readonly ['CANDIDATE', 'AGENT', 'SUPERVISOR', 'ADMIN'];
            };
          };
        };
      };
        ...
        readonly models: {
          ...
          readonly User: {
            ...
            readonly relations: {
              ...
              readonly candidateConversations: {
                readonly to: {
                  readonly namespace: 'public' & NamespaceId;
                  readonly model: 'Conversation';
                };
